                ...
                <div className="breadcumb-area">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item"><Link to="/bookings">Booking</Link></li>
                            <li className="breadcrumb-item active" aria-current="page">Detail</li>
                        </ol>
                    </nav>
                </div>

                <div className="single-course-intro d-flex align-items-center justify-content-center" style={{ backgroundImage: "url(https://dulich9.com/wp-content/uploads/2019/02/kinh-nghiem-du-loch-da-nang-0.jpg)" }}>
